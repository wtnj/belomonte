...
if Alltrim(aItens[2]) == "" .or. AllTrim(Strzero(Val(aItens[3]),4)) == ""
	...
	if !AK1->(dbSeek(xFilial("AK1")+Padr(aItens[2],TamSX3("AK2_ORCAME")[1])+AllTrim(Strzero(Val(aItens[3]),4)) ))
		aadd(aLogAux,"Planilha Or็amentแria "+Padr(aItens[2],TamSX3("AK2_ORCAME")[1])+AllTrim(Strzero(Val(aItens[3]),4))+" nใo Cadastrada!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[4]) == ""
	...
	if !AK5->(dbSeek(xFilial("AK5")+aItens[4] ))
		aadd(aLogAux,"Conta Or็amentแria "+aItens[4]+" nใo Cadastrada!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[6]) == ""
	...
	if !AK6->(dbSeek(xFilial("AK6")+aItens[6] ))
		aadd(aLogAux,"Classe Or็amentแria "+aItens[6]+" nใo Cadastrada!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[9]) == ""
	...
	if !AMF->(dbSeek(xFilial("AMF")+aItens[9] ))
		aadd(aLogAux,"Unidade Or็amentแria "+aItens[9]+" nใo Cadastrada!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[10]) == ""
	...
	if !AKF->(dbSeek(xFilial("AKF")+aItens[10] ))
		aadd(aLogAux,"Opera็ใo Or็amentแria "+aItens[10]+" nใo Cadastrada!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[12]) == ""
	...
	if !CTT->(dbSeek(xFilial("CTT")+aItens[12] ))
		aadd(aLogAux,"Centro de Custos "+aItens[12]+" nใo Cadastrado!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[16]) == ""
	...
	if !CTD->(dbSeek(xFilial("CTD")+aItens[16] ))
		aadd(aLogAux,"Item Contแbil "+aItens[16]+" nใo Cadastrado!"+c_ent)
		lRet := .F.
	endif
endif
...
if Alltrim(aItens[14]) == ""
	...
	if !CTH->(dbSeek(xFilial("CTH")+aItens[14] ))
		aadd(aLogAux,"Classe de Valor "+aItens[14]+" nใo Cadastrada!"+c_ent)
		lRet := .F.
	endif
endif
